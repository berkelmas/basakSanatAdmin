...
export const VERIFY_LOGIN = "[user reducer] verify_login";
export const LOGOUT = "[user reducer] logout";
export const GET_MENU = "[user reducer] get_menu";
export const SUCCESS_VERIFY_LOGIN = "[user reducer] success_verify_login";
